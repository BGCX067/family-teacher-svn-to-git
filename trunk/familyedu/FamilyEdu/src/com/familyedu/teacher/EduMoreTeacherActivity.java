...
import com.familyedu.student.EduFeedbackActivity;
 ...
 */
public class EduMoreTeacherActivity extends ActivityBase {
	...
	private void initView() {
		...
		back.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				EduMoreTeacherActivity.this.finish();
			}
		...
		if(twitterWindow == null){
			...
			twitterList.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Utilities.showToast(EduMoreTeacherActivity.this, scon);
	...
	class OnItemListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			case 1:
				...
				Utilities.showToast(EduMoreTeacherActivity.this, "手机通讯录匹配");
				break;
			case 2:
				
				Utilities.showToast(EduMoreTeacherActivity.this, "流量统计");
				break;
			case 3:
				
				Utilities.showToast(EduMoreTeacherActivity.this, "系统更新");
				break;
			case 4:
				
				startActivity(new Intent(EduMoreTeacherActivity.this, EduFeedbackActivity.class));
				break;
