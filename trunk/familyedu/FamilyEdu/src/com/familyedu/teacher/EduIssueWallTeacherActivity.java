...
import com.familyedu.student.EduIssueWall_queryConActivity;
 ...
 */
public class EduIssueWallTeacherActivity extends ActivityBase implements OnClickListener, OnItemClickListener{
	...
	public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
		...
		if(position == 0){ // 未回复
			...
			intent.putExtra("isreply", 2);
		
		}else{  // 已回复  
			
			intent.putExtra("isreply", 1);
		}
		intent.setClass(this, EduIssueWallConTeacherActivity.class);
